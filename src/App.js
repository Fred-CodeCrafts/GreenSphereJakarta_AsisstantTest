  ...
  return (
    <Router>
      <div className="bg-gray-100 min-h-screen flex flex-col">
        ...
        {/* Mobile Menu */}
        <div
          className={`md:hidden ${isMobileMenuOpen ? "block" : "hidden"} bg-green-600 text-white text-lg p-4`}
        >
          <Link to="/" className="block py-2 hover:text-gray-300">Home</Link>
          <Link to="/air-quality" className="block py-2 hover:text-gray-300">Air Quality</Link>
          <Link to="/news" className="block py-2 hover:text-gray-300">News</Link>
